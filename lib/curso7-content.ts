...
**Prompt específico:**
> "Dame 5 estrategias de marketing digital para una panadería artesanal en Buenos Aires que quiere atraer clientes de 25-40 años a través de Instagram. Incluye presupuesto estimado mensual para cada estrategia."
...
Mientras más contexto relevante des, mejor sera la respuesta. No tienes que contar tu vida entera — pero sí lo que sea relevante para la tarea.
...
**Con rol:**
> "Actúa como un contador especializado en pymes de México. Explicame qué es una LLC de Estados Unidos comparándola con una SA de CV mexicana. Usa lenguaje simple y dame pros y contras de cada una."
...
>
> Necesito escribir la descripción de un producto para mi tienda online de ropa deportiva. El producto es una playera de running de tela dry-fit, precio $15.000 MXN, dirigida a corredores amateur de 30-50 años. [CONTEXTO + ESPECIFICIDAD]
>
...
>
> - Reseña: 'Almorcé solo un martes, pide la milanesa napolitana. Estaba fría. La moza ni se acercó a preguntar si estaba todo bien.'
...
1. **Incluye casos borde** en tus ejemplos. Si hay un caso ambiguo o difícil, mostralo para que la IA sepa cómo manejarlo.
...
¿Alguna vez le pediste algo complejo a la IA y te dio una respuesta que suena convincente pero esta mal? Probablemente la IA "saltó" directamente a la conclusión sin pensar los pasos intermedios. Exactamente como cuando alguien responde una pregunta de matemáticas de memoria en vez de hacer la cuenta.
...
**Sin CoT:**
> "Tengo $500.000 MXN ahorrados. Debería invertir en un plazo fijo o en dólar MEP?"

La IA te da una recomendación directa que puede no considerar tu situación.

**Con CoT:**
> "Tengo $500.000 MXN ahorrados. Estoy considerando invertir en un plazo fijo o en dólar MEP. Antes de darme una recomendación, analiza los factores clave paso a paso: riesgo, rendimiento esperado, horizonte temporal, e inflación actual."
...
Los modelos de lenguaje fueron entrenados con millones de textos escritos por diferentes tipos de profesionales. Cuando le asignás un rol, estás diciéndole: "de todo lo que sabes, responde desde esta perspectiva específica". Es la diferencia entre preguntarle algo a un generalista vs a un especialista.
...
**1. Tutor paciente**
> "Actúa como un profesor de matemáticas de secundaria con 20 años de experiencia. Eres conocido por explicar conceptos difíciles de forma simple, usando analogías cotidianas. Nunca haces sentir tonto al alumno. Explicame qué son los logaritmos."
...
> - 'Tarda mucho el envío' → 'Disculpa la demora 🙏 Mándanos un DM con tu número de pedido y lo rastreamos de inmediato'
>
...
3. **No darle la tarea:** Asignás el rol pero después haces una pregunta genérica. El rol sin tarea específica no agrega mucho.
4. **Olvidar el contexto:** "Actúa como nutricionista" sin decir nada sobre tú. El rol necesita saber para quién trabaja.
...
> \`<instrucciones>
> Revisa el siguiente artículo de blog. Evalúa tres aspectos: claridad, estructura y engagement. Para cada aspecto dá una nota del 1 al 10 y sugerencias concretas de mejora.
> </instrucciones>
>
> <articulo>
...
Piénsalo como las instrucciones que le das a un nuevo empleado el primer día: "Eres recepcionista, siempre saludás con una sonrisa, respondes en español, y si te preguntan por precios deriva al departamento de ventas."
...
1. **Testa tu system prompt** con preguntas variadas. Un buen system prompt funciona bien con cualquier pregunta dentro de su dominio.
...
**Iteración 1:**
> "Demasiado formal. Mi jefe es bastante relajado y nos hablamos de ti. Hazlo más casual pero profesional."
...
Estas no son técnicas teóricas — son herramientas prácticas que puedes aplicar desde hoy en cada conversación con IA. La diferencia entre alguien que "usa IA" y alguien que realmente le saca provecho esta precisamente en la calidad de sus prompts.
