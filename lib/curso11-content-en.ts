...
export const c11leccion7 = `## Quiz: Automate with AI
...
a) Having robots replace all humans
b) Using AI to perform repetitive tasks intelligently without manual intervention
c) Programming in a computer language
d) Using your phone faster

**Correct answer: b)**
AI-powered automation allows repetitive tasks to be performed intelligently, understanding context and making simple decisions.

---

### Question 2
**In Zapier, what is a "Trigger"?**
a) The name of the flow
b) The event that starts the automation
c) The final result
d) A system error

**Correct answer: b)**
The Trigger is the event that kicks off the flow, such as receiving a new email or a completed form.

---

### Question 3
**What is the main advantage of Make over Zapier?**
a) It's prettier
b) It has more free operations and allows more complex flows
c) It only works in Spanish
...
**What is n8n?**
a) A new AI model
b) A free, open source automation tool
...
### Question 5
**When automating email responses, what is the best practice to start with?**
a) Enable automatic sending immediately
b) Set up responses as drafts to review them before sending
c) Reply to all emails with the same generic response
d) Stop reading emails altogether

**Correct answer: b)**
Starting with drafts lets you review the quality of automatic responses before trusting direct sending.
...
b) Creating applications by describing what you want in natural language
c) A web design style
d) A computer brand

**Correct answer: b)**
Vibe coding is describing in English (or any language) what you want an application to do, and the AI generates the code.

---

### Question 7
**Which of these tools is for vibe coding?**
a) Microsoft Excel
b) Bolt.new
c) Gmail
d) Spotify
...
**Correct answer: b)**
Bolt.new lets you create complete web applications from a natural language description.

---

### Question 8
**An automatic weekly sales report typically includes:**
a) Just a total number
b) Summary, key metrics, comparison with the previous period, and recommendations
c) A team photo
d) Just the salespeople's names
...
b) Because AI can generate incorrect or inappropriate responses
c) Because they use too much memory
d) Because they're very slow

**Correct answer: b)**
AI can make mistakes or generate inappropriate responses, so it's crucial to supervise, especially at the beginning.

---

### Question 10
**What is the recommended first step for getting started with automation?**
a) Automate all company processes at once
b) Identify a repetitive task you do every day and automate it
c) Buy the most expensive plan for every tool
d) Learn to code from scratch
...
- **8-10 correct**: Excellent. You're ready to automate your workflow.
